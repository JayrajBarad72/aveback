    ...
    <table width="100%" cellpadding="0" cellspacing="0" style="background:#16121F;border-radius:12px;">
      <tr><td style="padding:24px 28px;text-align:center;">
        ...
        <table cellpadding="0" cellspacing="0" border="0" role="presentation" align="center" style="margin:0 auto;">
          <tr>
            <td bgcolor="#7C3AED" style="border-radius:8px;padding:13px 32px;">
              <a href="https://calendly.com/aventrixtechnologies-info" style="font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Helvetica,Arial,sans-serif;font-size:14px;font-weight:600;color:#ffffff;text-decoration:none;white-space:nowrap;">Schedule My Demo &rarr;</a>
            </td>
          </tr>
        </table>
      </td></tr>
